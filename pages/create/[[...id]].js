...
const ProductsManager = () => {
    ...
    const {title, price, inStock, description, video, content, category} = product
            ...
            <form className="row" onSubmit={handleSubmit}>
                <div className="col-md-6">
                    ...
                    <div className="col-sm-6">
                            ...
                            <input type="type" name="video" value={video}
                            placeholder="Video" className="d-block w-100 p-2"
                            onChange={handleChangeInput} />
                        </div>
